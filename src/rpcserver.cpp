...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Mymn features */
        {"mymn", "masternode", &masternode, true, true, false},
        {"mymn", "listmasternodes", &listmasternodes, true, true, false},
        {"mymn", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mymn", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mymn", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mymn", "masternodedebug", &masternodedebug, true, true, false},
        {"mymn", "startmasternode", &startmasternode, true, true, false},
        {"mymn", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mymn", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mymn", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mymn", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mymn", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mymn", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mymn", "mnbudget", &mnbudget, true, true, false},
        {"mymn", "preparebudget", &preparebudget, true, true, false},
        {"mymn", "submitbudget", &submitbudget, true, true, false},
        {"mymn", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mymn", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mymn", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mymn", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mymn", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mymn", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mymn", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mymn", "checkbudgets", &checkbudgets, true, true, false},
        {"mymn", "mnsync", &mnsync, true, true, false},
        {"mymn", "spork", &spork, true, true, false},
        {"mymn", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"mymn", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use mymnd, or the -server option to mymn-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> mymn-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:10461/\n";
}
