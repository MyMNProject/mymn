                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Mymn from zMymn"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zMymn"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zMymn));
