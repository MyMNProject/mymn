...
Value obfuscation(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() == 0)
        throw runtime_error(
            "obfuscation <mymnaddress> <amount>\n"
            "mymnaddress, reset, or auto (AutoDenominate)"
    ...
    if (params.size() != 2)
        throw runtime_error(
            "obfuscation <mymnaddress> <amount>\n"
            "mymnaddress, denominate, or auto (AutoDenominate)"
            "<amount> is a real and will be rounded to the next 0.1" +
            HelpRequiringPassphrase());
...
Value getpoolinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"current\": \"addr\",    (string) Mymn address of current masternode\n"
            "  \"state\": mymnx,        (string) unknown\n"
            "  \"entries\": mymnx,      (numeric) Number of entries\n"
            "  \"accepted\": mymnx,     (numeric) Number of entries accepted\n"
            "}\n"
...
Value masternode(const Array& params, bool fHelp)
{
    ...
    if (fHelp ||
        ...
        throw runtime_error(
            ...
            "  start        - Start masternode configured in mymn.conf\n"
...
Value listmasternodes(const Array& params, bool fHelp)
{
    ...
    if (fHelp || (params.size() > 1))
        throw runtime_error(
            ...
            "    \"addr\": \"addr\",      (string) Masternode Mymn address\n"
...
Value masternodeconnect(const Array& params, bool fHelp)
{
    if (fHelp || (params.size() != 1))
        throw runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("masternodeconnect", "\"192.168.0.6:41474\"") + HelpExampleRpc("masternodeconnect", "\"192.168.0.6:41474\""));
...
Value masternodecurrent (const Array& params, bool fHelp)
{
    if (fHelp || (params.size() != 0))
        throw runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"protocol\": mymnx,        (numeric) Protocol version\n"
            "  \"txhash\": \"mymnx\",      (string) Collateral transaction hash\n"
            "  \"pubkey\": \"mymnx\",      (string) MN Public key\n"
            "  \"lastseen\": mymn,       (numeric) Time since epoch of last seen\n"
            "  \"activeseconds\": mymn,  (numeric) Seconds MN has been active\n"
            "}\n"
            "\nExamples:\n" +
...
Value startmasternode (const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 3 ||
        ...
        throw runtime_error(
            ...
            "{\n"
            "  \"overall\": \"mymnx\",     (string) Overall status message\n"
            "  \"detail\": [\n"
            "    {\n"
            "      \"node\": \"mymnx\",    (string) Node name or alias\n"
            "      \"result\": \"mymnx\",  (string) 'success' or 'failed'\n"
            "      \"error\": \"mymnx\"    (string) Error message, if failed\n"
            "    }\n"
            "    ,...\n"
            "  ]\n"
            "}\n"
...
Value getmasternodeoutputs (const Array& params, bool fHelp)
{
    if (fHelp || (params.size() != 0))
        throw runtime_error(
            ...
            "[\n"
            "  {\n"
            "    \"txhash\": \"mymnx\",    (string) output transaction hash\n"
...
Value listmasternodeconf (const Array& params, bool fHelp)
{
    ...
    if (fHelp || (params.size() > 1))
        throw runtime_error(
            ...
            "[\n"
            "  {\n"
            "    \"alias\": \"mymnx\",        (string) masternode alias\n"
            "    \"address\": \"mymnx\",      (string) masternode IP address\n"
            "    \"privateKey\": \"mymnx\",   (string) masternode private key\n"
            "    \"txHash\": \"mymnx\",       (string) transaction hash\n"
            "    \"outputIndex\": n,       (numeric) transaction output index\n"
            "    \"status\": \"mymnx\"        (string) masternode status\n"
            "  }\n"
            "  ,...\n"
            "]\n"
...
Value getmasternodestatus (const Array& params, bool fHelp)
{
    if (fHelp || (params.size() != 0))
        throw runtime_error(
            ...
            "  \"netaddr\": \"mymnx\",     (string) Masternode network address\n"
            "  \"addr\": \"mymnx\",        (string) Mymn address for masternode payments\n"
            "  \"status\": \"mymnx\",      (string) Masternode status\n"
            "  \"message\": \"mymnx\"      (string) Masternode status message\n"
            "}\n"
...
Value getmasternodewinners (const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 3)
        throw runtime_error(
            ...
            "    \"winner\": {\n"
            "      \"address\": \"mymnx\",    (string) Mymn MN Address\n"
...
Value getmasternodescores (const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  mymnx: \"mymnx\"   (numeric : string) Block height : Masternode hash\n"
            "  ,...\n"
            "}\n"
            "\nExamples:\n" +
