Contributing to Mymn Core
============================

The Mymn Core project operates an open contributor model where anyone is
...
Examples:
    ...
    Consensus: Add new opcode for BIP-MYMNX OP_CHECKAWESOMESIG
...
The following applies to code changes to the Mymn Core project, and is not to be
confused with overall Mymn Network Protocol consensus changes.

Whether a pull request is merged into Mymn Core rests with the project merge
...
Patches that change Mymn consensus rules are considerably more involved than
...
Where a patch set proposes to change the Mymn consensus, it must have been
...
The project leader is the release manager for each Mymn Core release.
