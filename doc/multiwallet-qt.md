...
In order to support loading of multiple wallets in mymn-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mymn.cpp.
...
Changes to mymn.cpp
----------------------
mymn.cpp is the entry point into mymn-qt, and as such, will require some minor modifications to provide hooks for
