...
ACLOCAL = ${SHELL} /root/mymn/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /root/mymn/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /root/mymn/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /root/mymn/build-aux/missing automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
...
CPPFLAGS = -I/usr/local/opt/openssl/include -DBOOST_SPIRIT_THREADSAFE -DHAVE_BUILD_INFO -D__STDC_FORMAT_MACROS  -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2
CRYPTO_CFLAGS = 
CRYPTO_LIBS = -lcrypto
CXX = g++
CXXCPP = g++ -E
...
LDFLAGS = -L/usr/local/opt/openssl/lib  -Wl,-z,relro -Wl,-z,now
LEVELDB_CPPFLAGS = 
...
LUPDATE = 
MAINT = 
MAKEINFO = ${SHELL} /root/mymn/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
PACKAGE_STRING = Mymn Core 1.3.0
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /root/mymn
abs_srcdir = /root/mymn
abs_top_builddir = /root/mymn
abs_top_srcdir = /root/mymn
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /root/mymn/build-aux/install-sh
