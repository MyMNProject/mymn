...
RESOURCES += src/qt/mymn.qrc src/qt/mymn_locale.qrc

TRANSLATIONS += src/qt/locale/mymn_bg.ts \
                src/qt/locale/mymn_de.ts \
                src/qt/locale/mymn_en.ts \
                src/qt/locale/mymn_es.ts \
                src/qt/locale/mymn_fi.ts \
                src/qt/locale/mymn_fr.ts \
                src/qt/locale/mymn_it.ts \
                src/qt/locale/mymn_ja.ts \
                src/qt/locale/mymn_pl.ts \
                src/qt/locale/mymn_pt.ts \
                src/qt/locale/mymn_ru.ts \
                src/qt/locale/mymn_sk.ts \
                src/qt/locale/mymn_sv.ts \
                src/qt/locale/mymn_vi.ts \
                src/qt/locale/mymn_zh_CN.ts \
                src/qt/locale/mymn_zh_TW.ts
