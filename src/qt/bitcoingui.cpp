                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Mymn Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Mymn address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mymn: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zMYMN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Mymn Core"), this);
    aboutAction->setStatusTip(tr("Show information about Mymn Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Mymn"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Mymn addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Mymn addresses"));
    ...
    openAction->setStatusTip(tr("Open a Mymn: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Mymn Core help message to get a list with possible Mymn command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Mymn Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Mymn network", "", count));
}
...
{
    QString strTitle = tr("Mymn Core"); // default title
